...
hi def link pythonRepeat    pythonRepeat
...
syn match pythonPatSepR "\((\|)\|{\|}\|<\|>\|\[\|\]\)"
syn keyword pythonSpecialWord self

hi def link pythonSpecialWord   Special
hi def link pythonDelimiter     pythonDelimiter
hi def link pythonRepeat        pythonRepeat
hi def link pythonStatement     pythonStatement
hi def link pythonConditional   pythonConditional
hi def link pythonRepeat        pythonRepeat
hi def link pythonOperator      pythonOperator
hi def link pythonException     pythonException
hi def link pythonInclude       pythonInclude
hi def link pythonAsync         pythonStatement
hi def link pythonDecorator     pythonDefine
hi def link pythonDecoratorName pythonFunction
hi def link pythonFunction      pythonFunction
hi def link pythonComment       pythonComment
hi def link pythonTodo          pythonTodo
hi def link pythonString        pythonString
hi def link pythonRawString     pythonString
hi def link pythonQuotes        pythonquotes
hi def link pythontriplequotes  pythonComment
hi def link pythonEscape        Special
